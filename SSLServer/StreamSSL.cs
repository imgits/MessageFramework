...
namespace SSLServer
{
    ...
    /// </summary>
    internal class StreamSSL : Stream
    {
        ...
        private const ServerSecurityContextAttribute SslServerAttribute1 =
            ServerSecurityContextAttribute.MutualAuth
            | ServerSecurityContextAttribute.Identify
            | ServerSecurityContextAttribute.Confidentiality
            | ServerSecurityContextAttribute.ReplayDetect
            | ServerSecurityContextAttribute.SequenceDetect
        ...
        private const ServerSecurityContextAttribute SslServerAttribute =
            ServerSecurityContextAttribute.ReplayDetect |
            ServerSecurityContextAttribute.SequenceDetect |
            ServerSecurityContextAttribute.Confidentiality |
            ServerSecurityContextAttribute.ExtendedError |
        ...
        public StreamSSL(Stream server, string principal)
        {
            if (server == null)
            {
        ...
        /// fails</exception>
        public void Authenticate(X509Certificate2 x509Cert)
        {
